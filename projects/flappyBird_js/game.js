...
const resetGame = () => {
    ...
    score = 0
    start = true
    bottonReset.style.display = 'none'
}
const showButton = () => {
    bottonReset.style.display = 'flex'
}

export let pointExport = 0
...
let intervalId = setInterval(loop, 1000 / FPS)
let bottonReset = document.getElementById('buttonReset')
